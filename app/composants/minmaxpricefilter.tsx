                        ...
                        <div className="flex items-center gap-3">
                            <div className="flex-1">
                                <input
                                    ...
                                    placeholder="Min"
                                    className="w-full px-3 py-2 text-sm border border-gray-200 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-yellow-500/20 focus:border-yellow-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
                                    min="0"
                                />
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                {[
                                    ...
                                    <button
                                        ...
                                        className="px-3 py-2 text-xs font-medium rounded-lg bg-gray-50 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-yellow-50 dark:hover:bg-yellow-900 hover:text-yellow-700 dark:hover:text-yellow-300 transition-colors"
                                    >
                                        {suggestion.label}
                                    </button>
                                ))}
