        ...
        {products.length === 0 ? (
          ...
          <div className="space-y-8">
            ...
            <div className="text-center py-16">
              <div className="backdrop-blur-xl bg-gradient-to-r from-[#A8D5BA]/5 via-[#F5E6CC]/5 to-[#A8D5BA]/5 border border-[#A8D5BA]/20 p-10 rounded-3xl max-w-4xl mx-auto">
                <h3 className="text-2xl sm:text-3xl font-bold text-[#374151] dark:text-white mb-6">
                  🎯 Continue ton shopping !
                </h3>
                <p className="text-[#374151] dark:text-gray-400 mb-8 max-w-2xl mx-auto text-lg">
                  Tu as du goût ! Découvre encore plus d'articles similaires ou partage tes propres trouvailles.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Link
                    href="/"
                    className="inline-flex items-center gap-3 bg-white dark:bg-[#2a2a2a] text-[#374151] dark:text-white font-semibold px-8 py-4 rounded-2xl border border-[#E5E7EB] dark:border-gray-600 hover:bg-[#FAFAFA] dark:hover:bg-[#333] transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105"
                  >
                  ...
                  <Link
                    href="/dashboard/add"
                    className="inline-flex items-center gap-3 bg-gradient-to-r from-[#6366F1] to-[#A8D5BA] text-white font-semibold px-8 py-4 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
                  >
                    <FaStore className="text-lg" />
                    Vendre mes articles
                  </Link>
